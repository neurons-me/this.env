**¿qué es un entorno (enviroment) para Monad?** 
**¿Y cómo generamos un sello identificador (hash/firma) que lo represente?**

#### Concepto: ¿Qué es this.env?

Un **env** representa el espacio de ejecución en el que monad.ai está operando. No se trata del contenido del lugar, sino de la percepción que **monad.ai** tiene de ese lugar en ese momento.
